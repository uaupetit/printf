...
/*   Updated: 2024/02/19 12:30:32 by uaupetit         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main()
{
	...
	ft_printf("dans la string %s, il y'a le char %c/n", s, c);
	printf("dans la string %s, il y'a le char %c/n", s, c);
	
	ft_printf("ma fonction : \nnb x : %x, nb X : %X  \n", nb, nb);
	printf("vrai fct : \nnb x : %x, nb X : %X \n", nb, nb);
	
	ft_printf("dans le nb %u, il y'a le chiffre  %u/n", nb, chiffre);
	printf("dans le nb %u, il y'a le chiffre  %u/n", nb, chiffre);
